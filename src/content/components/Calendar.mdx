---
title: Calendar
description: A Jetpack Compose calendar component. Supports single date selection, date range selection, date restriction modes, month/year picker dialogs, and full color customization.
---
...
```kotlin
import com.komoui.components.Calendar
import com.komoui.components.YearMonth
import kotlinx.datetime.LocalDate
