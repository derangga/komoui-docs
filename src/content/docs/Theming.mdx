...
KomoUI provides a ShadcnColors class that manages the color scheme configuration.
...
KomoUI provides the ShadcnRadius class to define corner radius configurations used across components.
